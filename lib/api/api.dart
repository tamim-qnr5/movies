...
import '../model/categories/Genr.dart';
...
import '../model/movie_list/Results.dart';
import '../model/popular/Popular_movies.dart';
import '../model/popular/Results.dart';
import '../model/similar/Similar_movies.dart';
...
class ApiManager extends ChangeNotifier {
  ...
  getCategoryList(int movieId) async {
    ...
    try {
      var url = Uri.https(baseUrl, '3//movie/$movieId/lists', {
        'api_key': '7aa09e7c4adae327e284850da455d2b0',
      }); //   1
